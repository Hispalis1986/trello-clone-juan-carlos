            ...
            <div class="relative min-w-[400px] max-w-[450px] px-4">
                <div class="relative rounded-lg bg-white shadow">
                    ...
                    <div class="p-6 pt-0 text-center">
                        <svg class="mx-auto mb-4 h-14 w-14 text-gray-400" fill="none" stroke="currentColor"
                        ...
                        <div class="flex w-full justify-center">
                            <div class="flex w-2/3 place-items-center justify-evenly">
                                <Button type="primary" size="md" rounded="md" @click="modalAction('confirm')">
                                    Yes
                                </Button>
                                <Button model="outline" size="md" rounded="md" @click="modalAction('close')">
                                    No
                                </Button>
                            </div>
                        </div>
